...
public class RuleEnrollmentTests {
  ...
  public void createShouldThrowOnNullStatus() {
    thrown.expect(NullPointerException.class);
    RuleEnrollment.create("test_enrollment", new Date(), new Date(), null, null,
  ...
  public void createShouldPropagatePropertiesCorrectly() {
    ...
    RuleEnrollment ruleEnrollment = RuleEnrollment.create(
        "test_enrollment", incidentDate, enrollmentDate,
        RuleEnrollment.Status.ACTIVE, "", "",
        Arrays.asList(ruleAttributeValueOne, ruleAttributeValueTwo,
                      ruleAttributeValueThree),
        "");
    ...
    assertThat(ruleEnrollment.attributeValues().get(0))
        .isEqualTo(ruleAttributeValueOne);
    assertThat(ruleEnrollment.attributeValues().get(1))
        .isEqualTo(ruleAttributeValueTwo);
    assertThat(ruleEnrollment.attributeValues().get(2))
        .isEqualTo(ruleAttributeValueThree);
  }
  ...
  public void createShouldReturnImmutableList() {
    ...
    RuleEnrollment ruleEnrollment = RuleEnrollment.create(
        "test_enrollment", new Date(), new Date(), RuleEnrollment.Status.ACTIVE,
    ...
    try {
      ...
      fail(
          "UnsupportedOperationException was expected, but nothing was thrown.");
