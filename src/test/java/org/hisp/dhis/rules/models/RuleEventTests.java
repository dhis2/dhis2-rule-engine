...
public class RuleEventTests {
  ...
  public void createShouldThrowExceptionIfStatusIsNull() {
    thrown.expect(NullPointerException.class);
    RuleEvent.create("test_event", "test_programstage", null, new Date(),
                     new Date(), null, null, Arrays.<RuleDataValue>asList(),
                     "");
  }
  ...
  public void createShouldPropagateImmutableList() {
    ...
    RuleEvent ruleEvent = RuleEvent.create(
        "test_event_uid", "test_stage_uid", RuleEvent.Status.ACTIVE, new Date(),
  ...
  public void createShouldPropagateValuesCorrectly() {
    ...
    RuleEvent ruleEvent = RuleEvent.create("test_event_uid", "test_stage_uid",
                                           RuleEvent.Status.ACTIVE, eventDate,
  ...
  public void eventDateComparatorTest() throws ParseException {
    ...
    List<RuleEvent> ruleEvents = Arrays.asList(
        RuleEvent.create(
            ...
            null, new ArrayList<RuleDataValue>(), ""),
        RuleEvent.create(
