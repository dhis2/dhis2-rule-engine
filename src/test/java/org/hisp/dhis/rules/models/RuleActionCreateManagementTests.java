...
public class RuleActionCreateManagementTests
{

        @Test
        public void createMustSubstituteEmptyStringsForNullArguments()
        {
                RuleActionCreateManagement ruleActionAssignNoContent = RuleActionCreateManagement
                    .create( null, "test_data", "test_program_stage" );
                RuleActionCreateManagement ruleActionAssignNoField = RuleActionCreateManagement
        ...
        public void createMustThrowWhenFieldIsNull()
        {
                try
                {
                        RuleActionCreateManagement.create( "test_content", "test_data", null );
        ...
        {
                EqualsVerifier.forClass( RuleActionCreateManagement
