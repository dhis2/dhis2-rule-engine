...
actual class RuleVariableValueMapBuilder actual constructor() {
    ...
    init {
        this.dateFormat = SimpleDateFormat(DATE_PATTERN)
    ...
    private actual constructor(ruleEnrollment: RuleEnrollment) : this() {

        // enrollment is the target
        this.ruleEnrollment = ruleEnrollment
    }

    private actual constructor(ruleEvent: RuleEvent) : this() {
