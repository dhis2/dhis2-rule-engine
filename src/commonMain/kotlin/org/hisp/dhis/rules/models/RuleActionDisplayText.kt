...
data class RuleActionDisplayText(override var content: String?,
    ...
    companion object {
        ...
        @JvmStatic fun createForFeedback(content: String?, data: String?): RuleActionDisplayText {
            return when {
        ...
        @JvmStatic fun createForIndicators(content: String?, data: String?): RuleActionDisplayText {
            return when {
                content == null && data == null -> throw IllegalArgumentException("Both content and data must not be null")
