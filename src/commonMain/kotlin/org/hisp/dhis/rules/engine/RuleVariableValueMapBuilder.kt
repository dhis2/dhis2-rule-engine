...
internal class RuleVariableValueMapBuilder {
    ...
    fun build(allConstantValues: Map<String, String>, ruleVariables: List<RuleVariable>, ruleEvents: Set<RuleEvent>, ruleEnrollment: RuleEnrollment? = null, ruleEvent: RuleEvent? = null): Map<String, RuleVariableValue> {
        val allEvents = ruleEvent?.let { val set = HashSet(ruleEvents); set.add(it); set.toSet() } ?: ruleEvents
        return buildEnvironmentVariables(allEvents, ruleEnrollment, ruleEvent) + buildRuleVariableValues(ruleVariables, allEvents, ruleEnrollment, ruleEvent) + buildConstantsValues(allConstantValues)
    }

    fun multipleBuild(allConstantValues: Map<String, String>, ruleVariables: List<RuleVariable>, ruleEvents: Set<RuleEvent>, ruleEnrollment: RuleEnrollment? = null): RuleVariableValueMap {
        val enrollmentMap = ruleEnrollment?.let { enrollment -> mapOf(Pair(enrollment, build(allConstantValues, ruleVariables, ruleEvents, ruleEnrollment))) }.orEmpty()
    ...
    private fun buildConstantsValues(allConstantValues: Map<String, String>): Map<String, RuleVariableValue> {
        return allConstantValues.mapValues { RuleVariableValue(RuleValueType.NUMERIC, it.value) }
    }

    private fun buildEnvironmentVariables(ruleEvents: Set<RuleEvent>, ruleEnrollment: RuleEnrollment?, ruleEvent: RuleEvent?): Map<String, RuleVariableValue> {
    ...
    private fun buildEnvironmentVariables(ruleEvents: Set<RuleEvent>, currentDate: LocalDate): Map<String, RuleVariableValue> {
    ...
    private fun buildEventEnvironmentVariables(ruleEvents: Set<RuleEvent>, ruleEvent: RuleEvent, currentDate: LocalDate): Map<String, RuleVariableValue> {
        val valueMap: MutableMap<String, RuleVariableValue> = HashMap()
    ...
    private fun buildEnrollmentEnvironmentVariables(ruleEnrollment: RuleEnrollment, currentDate: LocalDate): Map<String, RuleVariableValue> {
        val valueMap: MutableMap<String, RuleVariableValue> = HashMap()
    ...
    private fun buildRuleVariableValues(ruleVariables: List<RuleVariable>, ruleEvents: Set<RuleEvent>, ruleEnrollment: RuleEnrollment?, ruleEvent: RuleEvent?): Map<String, RuleVariableValue> {
