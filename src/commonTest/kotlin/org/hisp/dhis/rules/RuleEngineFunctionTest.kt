...
class RuleEngineFunctionTest {
    ...
    fun evaluateFailingRule() {
        ...
        val ruleEnrollment =
            RuleEnrollment(
                "test_enrollment",
                "",
                RuleLocalDate.fromLocalDate(enrollmentDate),
                RuleLocalDate.fromLocalDate(enrollmentDate),
    ...
    fun evaluateFailingRuleInMultipleContext() {
        ...
        val ruleEnrollment =
            RuleEnrollment(
                "test_enrollment",
                "",
                RuleLocalDate.fromLocalDate(today),
                RuleLocalDate.fromLocalDate(today),
                RuleEnrollmentStatus.ACTIVE,
                "",
                "",
        ...
        val ruleNotFailingEvent =
            RuleEvent(
                ...
                "",
                RuleEventStatus.ACTIVE,
                RuleLocalDate.fromLocalDate(today.minus(1, DateTimeUnit.DAY)),
                RuleInstant.fromInstant(yesterday),
                null,
                RuleLocalDate.fromLocalDate(today),
                null,
                "",
    ...
    fun evaluateLastEventDate() {
        ...
        val dayAfterTomorrow = currentDate().plus(2, DateTimeUnit.DAY)
        val ruleAction =
            RuleAction(
        ...
        val ruleEvent1 =
            RuleEvent(
                ...
                "",
                RuleEventStatus.ACTIVE,
                RuleLocalDate.fromLocalDate(currentDate().minus(2, DateTimeUnit.DAY)),
                RuleInstant.fromInstant(dayBeforeYesterday),
                null,
                RuleLocalDate.currentDate(),
                null,
                "",
        ...
        val ruleEvent2 =
            RuleEvent(
                ...
                "",
                RuleEventStatus.ACTIVE,
                RuleLocalDate.fromLocalDate(currentDate().minus(1, DateTimeUnit.DAY)),
                RuleInstant.fromInstant(yesterday),
                null,
                RuleLocalDate.currentDate(),
                null,
        ...
        val ruleEvent3 =
            RuleEvent(
                ...
                "",
                RuleEventStatus.ACTIVE,
                RuleLocalDate.fromLocalDate(dayAfterTomorrow),
                RuleInstant.fromInstant(dayAfterTomorrowInstant),
                null,
                RuleLocalDate.currentDate(),
                null,
                "",
