...
@Generated("com.google.auto.value.processor.AutoValueProcessor")
 final class AutoValue_RuleVariableCurrentEvent extends RuleVariableCurrentEvent {
  ...
  AutoValue_RuleVariableCurrentEvent(
      String name,
      String dataElement,
  ...
  public String toString() {
    return "RuleVariableCurrentEvent{"
        + "name=" + name + ", "
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RuleVariableCurrentEvent) {
      RuleVariableCurrentEvent that = (RuleVariableCurrentEvent) o;
